        ...
        <div class="row">
            <div class="col-xl-4">
                ...
                <div class="card mb-4 mb-xl-0">
                    <div class="card-header mb-2">Profile Picture</div>
                    <div class="card-body text-center">
                        <!-- Profile picture image-->
                        <img class="img-account-profile rounded-circle mb-2"
                            src="{{ asset('uploads/user') }}/{{ Auth::user()->user_image }}" alt="">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('student.profileImageChange', ['id' => Auth::user()->id]) }}" method="POST"
            ...
            <div class="col-xl-8">
                ...
                <div class="card mb-4">
                    <div class="card-header mb-4">Account Details</div>
                    ...
                    <div class="card-body ">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <p class="text-muted mb-0">{{ $user->semester->semester_name }}</p>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <p class="text-muted mb-0">{{ $user->department->full_name }}</p>
                            </div>
                        </div><hr>
                        <div class="row pt-1">
                            <div class="col-sm-3">
