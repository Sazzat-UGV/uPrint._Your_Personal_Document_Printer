        ...
        <div class="card-body">
          <form action="{{ route('department.store') }}" method="POST">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input type="text"  id="department_full_name" name="department_full_name" placeholder="enter department full name" class="form-control @error('department_full_name')
                is-invalid
                @enderror"/>
